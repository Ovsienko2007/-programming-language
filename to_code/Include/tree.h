...
{SQRT               , "sqrt"  , "SQRT"  , "sqrt"   , sizeof("sqrt"   ) - 1, 2, math          },
...
{IF                 , "Во имя Императора выполни если" , "if"    , "if"     , sizeof("if"     ) - 1, 2, conditional_op},
{WHILE              , "Во имя Императора выполняй пока", "while" , "while"  , sizeof("while"  ) - 1, 2, conditional_op},
{ELSE               , "В противном случае"             , "else"  , "else"   , sizeof("else"   ) - 1, 2, conditional_op},
{ASSIGN             , "даруй значение"                 , "="     , "="      , sizeof("="      ) - 1, 2, assign_op     },
{CONNECTING_NODE    , "с консоли"                      , ";"     , ";"      , sizeof(";"      ) - 1, 2, no_type       },
{INPUT              , "отдай"                          , "IN"    , "input"  , sizeof("input"  ) - 1, 0, bracket       }, 
{PRINT              , "Именем Омнииссии заклинаю тебя, Машина, выведи сии значения в консоль:", "OUT"   , "print"  , sizeof("print"  ) - 1, 0, bracket       },
{FUNC               , "О, Омнииссия, даруй же Машине силы выполнить сей приказ"               , "FUNC"  , "FUNC"   , sizeof("FUNC"   ) - 1, 0, func_type     },
};
